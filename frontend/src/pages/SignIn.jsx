                            ...
                            <div>
                                <form>
                                    ...
                                    <div class="relative mt-6">
                                        ...
                                        {/* <a class="absolute top-0 right-0 text-sm/6 text-gray-600 hover:text-gray-800" tabindex="4" href="javascript:;">Forgot password?</a> */}
                                    </div>
                                    <button type="submit" class="mt-10 w-full inline-flex justify-center rounded-full text-sm/6 font-semibold bg-gray-950 text-white hover:bg-gray-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-950 px-4 py-2" tabindex="3">Sign In</button>
                                    <p class="mt-6 text-sm/6">
                                        <span class="text-gray-600">Don &#x27;t have an account?</span>
                                        <a class="font-semibold hover:text-gray-700" tabindex="5" href="/signup">
